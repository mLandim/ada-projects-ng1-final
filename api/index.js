...
const churrascometro = require('./churrascometro.json')
...
const jwtValidation = (req, res, next) => {
  try {
    ...
    console.log(token)
    let skipTokenVAlidantion = ['/logout']
    
    if (!skipTokenVAlidantion.includes(req.url)) {
...
let carnes = churrascometro?.carnes;
...
let bebidas = churrascometro?.bebidas;
...
app.put("/bebidas/:id", (req, res) => {
  ...
  if (proibido_menores !== undefined) {
    bebida.proibido_menores = proibido_menores
  }
